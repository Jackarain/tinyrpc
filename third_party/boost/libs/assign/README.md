Assign, part of collection of the [Boost C++ Libraries](https://github.com/boostorg), makes it easy to fill containers with data by overloading operator() and operator()().
